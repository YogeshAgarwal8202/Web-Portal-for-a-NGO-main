...
// Create page object
if (!isset($user_gender_wise_rpt))
	$user_gender_wise_rpt = new user_gender_wise_rpt();
if (isset($Page))
	$OldPage = $Page;
$Page = &$user_gender_wise_rpt;
...
// Form object
var fuser_gender_wiserpt = currentForm = new ew.Form("fuser_gender_wiserpt");

// Validate method
fuser_gender_wiserpt.validate = function() {
...
fuser_gender_wiserpt.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!

	// Your custom validation code here, return false if invalid.
	return true;
}
<?php if (CLIENT_VALIDATE) { ?>
fuser_gender_wiserpt.validateRequired = true; // Uses JavaScript validation
<?php } else { ?>
fuser_gender_wiserpt.validateRequired = false; // No JavaScript validation
<?php } ?>

// Use Ajax
fuser_gender_wiserpt.lists["x_user_gender"] = <?php echo $user_gender_wise_rpt->user_gender->Lookup->toClientList() ?>;
fuser_gender_wiserpt.lists["x_user_gender"].options = <?php echo JsonEncode($user_gender_wise_rpt->user_gender->lookupOptions()) ?>;
</script>
<?php } ?>
<?php if ($Page->Export == "" && !$Page->DrillDown && !$DashboardReport) { ?>
<script>
...
<div id="ew-center" class="<?php echo $user_gender_wise_rpt->CenterContentClass ?>">
<?php } ?>
...
<?php
	...
	$Page->renderRow();
?>
<form name="fuser_gender_wiserpt" id="fuser_gender_wiserpt" class="form-inline ew-form ew-ext-filter-form" action="<?php echo CurrentPageName() ?>">
<?php $searchPanelClass = ($Page->Filter <> "") ? " show" : " show"; ?>
<div id="fuser_gender_wiserpt-search-panel" class="ew-search-panel collapse<?php echo $searchPanelClass ?>">
<input type="hidden" name="cmd" value="search">
<div id="r_1" class="ew-row d-sm-flex">
<div id="c_user_gender" class="ew-cell form-group">
	<label for="x_user_gender" class="ew-search-caption ew-label"><?php echo $Page->user_gender->caption() ?></label>
	<span class="ew-search-field">
<?php $Page->user_gender->EditAttrs["onchange"] = "ew.forms(this).submit(); " . @$Page->user_gender->EditAttrs["onchange"]; ?>
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="user_gender_wise" data-field="x_user_gender" data-value-separator="<?php echo $Page->user_gender->displayValueSeparatorAttribute() ?>" id="x_user_gender" name="x_user_gender"<?php echo $Page->user_gender->editAttributes() ?>>
		<?php echo $Page->user_gender->selectOptionListHtml("x_user_gender") ?>
	</select>
</div>
<?php echo $Page->user_gender->Lookup->getParamTag("p_x_user_gender") ?>
</span>
</div>
</div>
</div>
...
<script>
fuser_gender_wiserpt.filterList = <?php echo $Page->getFilterList() ?>;
</script>
<!-- Search form (end) -->
<?php } ?>
...
<!-- Report grid (begin) -->
<?php if ($Page->Export <> "pdf") { ?>
<div id="gmp_user_gender_wise" class="<?php if (IsResponsiveLayout()) { echo "table-responsive "; } ?>ew-grid-middle-panel">
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_id"><div class="user_gender_wise_user_id"><span class="ew-table-header-caption"><?php echo $Page->user_id->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_id">
<?php if ($Page->sortUrl($Page->user_id) == "") { ?>
		<div class="ew-table-header-btn user_gender_wise_user_id">
			<span class="ew-table-header-caption"><?php echo $Page->user_id->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_gender_wise_user_id" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->user_id) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->user_id->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="type_name"><div class="user_gender_wise_type_name"><span class="ew-table-header-caption"><?php echo $Page->type_name->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="type_name">
<?php if ($Page->sortUrl($Page->type_name) == "") { ?>
		<div class="ew-table-header-btn user_gender_wise_type_name">
			<span class="ew-table-header-caption"><?php echo $Page->type_name->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_gender_wise_type_name" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->type_name) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->type_name->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_name"><div class="user_gender_wise_user_name"><span class="ew-table-header-caption"><?php echo $Page->user_name->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_name">
<?php if ($Page->sortUrl($Page->user_name) == "") { ?>
		<div class="ew-table-header-btn user_gender_wise_user_name">
			<span class="ew-table-header-caption"><?php echo $Page->user_name->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_gender_wise_user_name" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->user_name) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->user_name->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_gender"><div class="user_gender_wise_user_gender"><span class="ew-table-header-caption"><?php echo $Page->user_gender->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_gender">
<?php if ($Page->sortUrl($Page->user_gender) == "") { ?>
		<div class="ew-table-header-btn user_gender_wise_user_gender">
			<span class="ew-table-header-caption"><?php echo $Page->user_gender->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_gender_wise_user_gender" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->user_gender) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->user_gender->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_dob"><div class="user_gender_wise_user_dob"><span class="ew-table-header-caption"><?php echo $Page->user_dob->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_dob">
<?php if ($Page->sortUrl($Page->user_dob) == "") { ?>
		<div class="ew-table-header-btn user_gender_wise_user_dob">
			<span class="ew-table-header-caption"><?php echo $Page->user_dob->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_gender_wise_user_dob" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->user_dob) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->user_dob->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_email"><div class="user_gender_wise_user_email"><span class="ew-table-header-caption"><?php echo $Page->user_email->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_email">
<?php if ($Page->sortUrl($Page->user_email) == "") { ?>
		<div class="ew-table-header-btn user_gender_wise_user_email">
			<span class="ew-table-header-caption"><?php echo $Page->user_email->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_gender_wise_user_email" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->user_email) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->user_email->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_mobile"><div class="user_gender_wise_user_mobile"><span class="ew-table-header-caption"><?php echo $Page->user_mobile->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_mobile">
<?php if ($Page->sortUrl($Page->user_mobile) == "") { ?>
		<div class="ew-table-header-btn user_gender_wise_user_mobile">
			<span class="ew-table-header-caption"><?php echo $Page->user_mobile->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_gender_wise_user_mobile" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->user_mobile) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->user_mobile->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_country_code"><div class="user_gender_wise_user_country_code"><span class="ew-table-header-caption"><?php echo $Page->user_country_code->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_country_code">
<?php if ($Page->sortUrl($Page->user_country_code) == "") { ?>
		<div class="ew-table-header-btn user_gender_wise_user_country_code">
			<span class="ew-table-header-caption"><?php echo $Page->user_country_code->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_gender_wise_user_country_code" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->user_country_code) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->user_country_code->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_blood_group"><div class="user_gender_wise_user_blood_group"><span class="ew-table-header-caption"><?php echo $Page->user_blood_group->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_blood_group">
<?php if ($Page->sortUrl($Page->user_blood_group) == "") { ?>
		<div class="ew-table-header-btn user_gender_wise_user_blood_group">
			<span class="ew-table-header-caption"><?php echo $Page->user_blood_group->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_gender_wise_user_blood_group" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->user_blood_group) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->user_blood_group->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_health_issue"><div class="user_gender_wise_user_health_issue"><span class="ew-table-header-caption"><?php echo $Page->user_health_issue->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_health_issue">
<?php if ($Page->sortUrl($Page->user_health_issue) == "") { ?>
		<div class="ew-table-header-btn user_gender_wise_user_health_issue">
			<span class="ew-table-header-caption"><?php echo $Page->user_health_issue->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_gender_wise_user_health_issue" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->user_health_issue) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->user_health_issue->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_location"><div class="user_gender_wise_user_location"><span class="ew-table-header-caption"><?php echo $Page->user_location->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_location">
<?php if ($Page->sortUrl($Page->user_location) == "") { ?>
		<div class="ew-table-header-btn user_gender_wise_user_location">
			<span class="ew-table-header-caption"><?php echo $Page->user_location->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_gender_wise_user_location" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->user_location) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->user_location->caption() ?></span>
...
<?php include "user_gender_wise_pager.php" ?>
