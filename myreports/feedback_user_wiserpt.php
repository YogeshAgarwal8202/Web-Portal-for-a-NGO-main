...
// Create page object
if (!isset($feedback_user_wise_rpt))
	$feedback_user_wise_rpt = new feedback_user_wise_rpt();
if (isset($Page))
	$OldPage = $Page;
$Page = &$feedback_user_wise_rpt;
...
// Form object
var ffeedback_user_wiserpt = currentForm = new ew.Form("ffeedback_user_wiserpt");

// Validate method
ffeedback_user_wiserpt.validate = function() {
...
ffeedback_user_wiserpt.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!

	// Your custom validation code here, return false if invalid.
	return true;
}
<?php if (CLIENT_VALIDATE) { ?>
ffeedback_user_wiserpt.validateRequired = true; // Uses JavaScript validation
<?php } else { ?>
ffeedback_user_wiserpt.validateRequired = false; // No JavaScript validation
<?php } ?>

// Use Ajax
ffeedback_user_wiserpt.lists["x_user_name"] = <?php echo $feedback_user_wise_rpt->user_name->Lookup->toClientList() ?>;
ffeedback_user_wiserpt.autoSuggests["x_user_name"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
</script>
<?php } ?>
<?php if ($Page->Export == "" && !$Page->DrillDown && !$DashboardReport) { ?>
<script>
...
<div id="ew-center" class="<?php echo $feedback_user_wise_rpt->CenterContentClass ?>">
<?php } ?>
...
<?php
	...
	$Page->renderRow();
?>
<form name="ffeedback_user_wiserpt" id="ffeedback_user_wiserpt" class="form-inline ew-form ew-ext-filter-form" action="<?php echo CurrentPageName() ?>">
<?php $searchPanelClass = ($Page->Filter <> "") ? " show" : " show"; ?>
<div id="ffeedback_user_wiserpt-search-panel" class="ew-search-panel collapse<?php echo $searchPanelClass ?>">
...
?>
<span id="as_x_user_name" class="text-nowrap" style="z-index: 8920">
...
<input type="hidden" data-table="feedback_user_wise" data-field="x_user_name" data-value-separator="<?php echo $Page->user_name->displayValueSeparatorAttribute() ?>" name="x_user_name" id="x_user_name" value="<?php echo HtmlEncode($Page->user_name->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script>
ffeedback_user_wiserpt.createAutoSuggest({"id":"x_user_name","forceSelect":false});
</script>
</span>
</div>
</div>
...
<script>
ffeedback_user_wiserpt.filterList = <?php echo $Page->getFilterList() ?>;
</script>
<!-- Search form (end) -->
<?php } ?>
...
<!-- Report grid (begin) -->
<?php if ($Page->Export <> "pdf") { ?>
<div id="gmp_feedback_user_wise" class="<?php if (IsResponsiveLayout()) { echo "table-responsive "; } ?>ew-grid-middle-panel">
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="feedback_id"><div class="feedback_user_wise_feedback_id"><span class="ew-table-header-caption"><?php echo $Page->feedback_id->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="feedback_id">
<?php if ($Page->sortUrl($Page->feedback_id) == "") { ?>
		<div class="ew-table-header-btn feedback_user_wise_feedback_id">
			<span class="ew-table-header-caption"><?php echo $Page->feedback_id->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer feedback_user_wise_feedback_id" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->feedback_id) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->feedback_id->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="feedback_date"><div class="feedback_user_wise_feedback_date"><span class="ew-table-header-caption"><?php echo $Page->feedback_date->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="feedback_date">
<?php if ($Page->sortUrl($Page->feedback_date) == "") { ?>
		<div class="ew-table-header-btn feedback_user_wise_feedback_date">
			<span class="ew-table-header-caption"><?php echo $Page->feedback_date->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer feedback_user_wise_feedback_date" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->feedback_date) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->feedback_date->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="feedback_time"><div class="feedback_user_wise_feedback_time"><span class="ew-table-header-caption"><?php echo $Page->feedback_time->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="feedback_time">
<?php if ($Page->sortUrl($Page->feedback_time) == "") { ?>
		<div class="ew-table-header-btn feedback_user_wise_feedback_time">
			<span class="ew-table-header-caption"><?php echo $Page->feedback_time->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer feedback_user_wise_feedback_time" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->feedback_time) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->feedback_time->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="feedback_description"><div class="feedback_user_wise_feedback_description"><span class="ew-table-header-caption"><?php echo $Page->feedback_description->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="feedback_description">
<?php if ($Page->sortUrl($Page->feedback_description) == "") { ?>
		<div class="ew-table-header-btn feedback_user_wise_feedback_description">
			<span class="ew-table-header-caption"><?php echo $Page->feedback_description->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer feedback_user_wise_feedback_description" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->feedback_description) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->feedback_description->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="event_title"><div class="feedback_user_wise_event_title"><span class="ew-table-header-caption"><?php echo $Page->event_title->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="event_title">
<?php if ($Page->sortUrl($Page->event_title) == "") { ?>
		<div class="ew-table-header-btn feedback_user_wise_event_title">
			<span class="ew-table-header-caption"><?php echo $Page->event_title->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer feedback_user_wise_event_title" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->event_title) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->event_title->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="event_date"><div class="feedback_user_wise_event_date"><span class="ew-table-header-caption"><?php echo $Page->event_date->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="event_date">
<?php if ($Page->sortUrl($Page->event_date) == "") { ?>
		<div class="ew-table-header-btn feedback_user_wise_event_date">
			<span class="ew-table-header-caption"><?php echo $Page->event_date->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer feedback_user_wise_event_date" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->event_date) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->event_date->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="event_location"><div class="feedback_user_wise_event_location"><span class="ew-table-header-caption"><?php echo $Page->event_location->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="event_location">
<?php if ($Page->sortUrl($Page->event_location) == "") { ?>
		<div class="ew-table-header-btn feedback_user_wise_event_location">
			<span class="ew-table-header-caption"><?php echo $Page->event_location->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer feedback_user_wise_event_location" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->event_location) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->event_location->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_name"><div class="feedback_user_wise_user_name"><span class="ew-table-header-caption"><?php echo $Page->user_name->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_name">
<?php if ($Page->sortUrl($Page->user_name) == "") { ?>
		<div class="ew-table-header-btn feedback_user_wise_user_name">
			<span class="ew-table-header-caption"><?php echo $Page->user_name->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer feedback_user_wise_user_name" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->user_name) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->user_name->caption() ?></span>
...
<?php include "feedback_user_wise_pager.php" ?>
