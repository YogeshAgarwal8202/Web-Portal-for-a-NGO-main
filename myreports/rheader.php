...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>Suryabala-Seva-logo.ico"><link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>Suryabala-Seva-logo.ico">
...
<div class="wrapper ew-layout">
	...
	<aside class="<?php echo $SIDEBAR_CLASS ?>">
		...
		<a href="#" class="brand-link">
			<img src="<?php echo $RELATIVE_PATH ?>phprptimages/Suryabala Seva logo.png" alt="" class="brand-image ew-brand-image">
		</a>
		<!-- Sidebar -->
		<div class="sidebar">
			<!-- Sidebar Menu -->
