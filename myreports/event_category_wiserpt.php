...
// Create page object
if (!isset($event_category_wise_rpt))
	$event_category_wise_rpt = new event_category_wise_rpt();
if (isset($Page))
	$OldPage = $Page;
$Page = &$event_category_wise_rpt;
...
// Form object
var fevent_category_wiserpt = currentForm = new ew.Form("fevent_category_wiserpt");

// Validate method
fevent_category_wiserpt.validate = function() {
...
fevent_category_wiserpt.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!

	// Your custom validation code here, return false if invalid.
	return true;
}
<?php if (CLIENT_VALIDATE) { ?>
fevent_category_wiserpt.validateRequired = true; // Uses JavaScript validation
<?php } else { ?>
fevent_category_wiserpt.validateRequired = false; // No JavaScript validation
<?php } ?>

// Use Ajax
fevent_category_wiserpt.lists["x_category_name"] = <?php echo $event_category_wise_rpt->category_name->Lookup->toClientList() ?>;
fevent_category_wiserpt.lists["x_category_name"].options = <?php echo JsonEncode($event_category_wise_rpt->category_name->lookupOptions()) ?>;
</script>
<?php } ?>
<?php if ($Page->Export == "" && !$Page->DrillDown && !$DashboardReport) { ?>
<script>
...
<div id="ew-center" class="<?php echo $event_category_wise_rpt->CenterContentClass ?>">
<?php } ?>
...
<?php
	...
	$Page->renderRow();
?>
<form name="fevent_category_wiserpt" id="fevent_category_wiserpt" class="form-inline ew-form ew-ext-filter-form" action="<?php echo CurrentPageName() ?>">
<?php $searchPanelClass = ($Page->Filter <> "") ? " show" : " show"; ?>
<div id="fevent_category_wiserpt-search-panel" class="ew-search-panel collapse<?php echo $searchPanelClass ?>">
...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="event_category_wise" data-field="x_category_name" data-value-separator="<?php echo $Page->category_name->displayValueSeparatorAttribute() ?>" id="x_category_name" name="x_category_name"<?php echo $Page->category_name->editAttributes() ?>>
...
<script>
fevent_category_wiserpt.filterList = <?php echo $Page->getFilterList() ?>;
</script>
<!-- Search form (end) -->
<?php } ?>
...
<!-- Report grid (begin) -->
<?php if ($Page->Export <> "pdf") { ?>
<div id="gmp_event_category_wise" class="<?php if (IsResponsiveLayout()) { echo "table-responsive "; } ?>ew-grid-middle-panel">
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="event_activity_num"><div class="event_category_wise_event_activity_num"><span class="ew-table-header-caption"><?php echo $Page->event_activity_num->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="event_activity_num">
<?php if ($Page->sortUrl($Page->event_activity_num) == "") { ?>
		<div class="ew-table-header-btn event_category_wise_event_activity_num">
			<span class="ew-table-header-caption"><?php echo $Page->event_activity_num->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_category_wise_event_activity_num" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->event_activity_num) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->event_activity_num->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="category_name"><div class="event_category_wise_category_name"><span class="ew-table-header-caption"><?php echo $Page->category_name->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="category_name">
<?php if ($Page->sortUrl($Page->category_name) == "") { ?>
		<div class="ew-table-header-btn event_category_wise_category_name">
			<span class="ew-table-header-caption"><?php echo $Page->category_name->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_category_wise_category_name" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->category_name) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->category_name->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="event_title"><div class="event_category_wise_event_title"><span class="ew-table-header-caption"><?php echo $Page->event_title->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="event_title">
<?php if ($Page->sortUrl($Page->event_title) == "") { ?>
		<div class="ew-table-header-btn event_category_wise_event_title">
			<span class="ew-table-header-caption"><?php echo $Page->event_title->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_category_wise_event_title" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->event_title) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->event_title->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="event_details"><div class="event_category_wise_event_details"><span class="ew-table-header-caption"><?php echo $Page->event_details->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="event_details">
<?php if ($Page->sortUrl($Page->event_details) == "") { ?>
		<div class="ew-table-header-btn event_category_wise_event_details">
			<span class="ew-table-header-caption"><?php echo $Page->event_details->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_category_wise_event_details" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->event_details) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->event_details->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="event_date"><div class="event_category_wise_event_date"><span class="ew-table-header-caption"><?php echo $Page->event_date->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="event_date">
<?php if ($Page->sortUrl($Page->event_date) == "") { ?>
		<div class="ew-table-header-btn event_category_wise_event_date">
			<span class="ew-table-header-caption"><?php echo $Page->event_date->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_category_wise_event_date" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->event_date) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->event_date->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="event_time"><div class="event_category_wise_event_time"><span class="ew-table-header-caption"><?php echo $Page->event_time->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="event_time">
<?php if ($Page->sortUrl($Page->event_time) == "") { ?>
		<div class="ew-table-header-btn event_category_wise_event_time">
			<span class="ew-table-header-caption"><?php echo $Page->event_time->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_category_wise_event_time" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->event_time) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->event_time->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="event_location"><div class="event_category_wise_event_location"><span class="ew-table-header-caption"><?php echo $Page->event_location->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="event_location">
<?php if ($Page->sortUrl($Page->event_location) == "") { ?>
		<div class="ew-table-header-btn event_category_wise_event_location">
			<span class="ew-table-header-caption"><?php echo $Page->event_location->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_category_wise_event_location" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->event_location) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->event_location->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="event_status"><div class="event_category_wise_event_status"><span class="ew-table-header-caption"><?php echo $Page->event_status->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="event_status">
<?php if ($Page->sortUrl($Page->event_status) == "") { ?>
		<div class="ew-table-header-btn event_category_wise_event_status">
			<span class="ew-table-header-caption"><?php echo $Page->event_status->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_category_wise_event_status" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->event_status) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->event_status->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Last_Updated_By"><div class="event_category_wise_Last_Updated_By"><span class="ew-table-header-caption"><?php echo $Page->Last_Updated_By->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Last_Updated_By">
<?php if ($Page->sortUrl($Page->Last_Updated_By) == "") { ?>
		<div class="ew-table-header-btn event_category_wise_Last_Updated_By">
			<span class="ew-table-header-caption"><?php echo $Page->Last_Updated_By->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_category_wise_Last_Updated_By" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->Last_Updated_By) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->Last_Updated_By->caption() ?></span>
...
<?php include "event_category_wise_pager.php" ?>
