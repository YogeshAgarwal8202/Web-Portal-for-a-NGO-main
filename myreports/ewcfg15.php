...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "sss"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'OcrUhM9r3NeME6dx'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phprptcss/sss.css"); // Project stylesheet file name
...
$PROJECT_ID = "{81EFA82E-70F6-4CCE-A7DF-BF937D3A46A2}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$NAVBAR_CLASS = "main-header navbar navbar-expand navbar-dark bg-info border-bottom";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "myproject", "qs" => "`", "qe" => "`");
