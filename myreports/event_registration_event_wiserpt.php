...
// Create page object
if (!isset($event_registration_event_wise_rpt))
	$event_registration_event_wise_rpt = new event_registration_event_wise_rpt();
if (isset($Page))
	$OldPage = $Page;
$Page = &$event_registration_event_wise_rpt;
...
// Form object
var fevent_registration_event_wiserpt = currentForm = new ew.Form("fevent_registration_event_wiserpt");

// Validate method
fevent_registration_event_wiserpt.validate = function() {
...
fevent_registration_event_wiserpt.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!

	// Your custom validation code here, return false if invalid.
	return true;
}
<?php if (CLIENT_VALIDATE) { ?>
fevent_registration_event_wiserpt.validateRequired = true; // Uses JavaScript validation
<?php } else { ?>
fevent_registration_event_wiserpt.validateRequired = false; // No JavaScript validation
<?php } ?>

// Use Ajax
fevent_registration_event_wiserpt.lists["x_event_title"] = <?php echo $event_registration_event_wise_rpt->event_title->Lookup->toClientList() ?>;
fevent_registration_event_wiserpt.autoSuggests["x_event_title"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
</script>
<?php } ?>
<?php if ($Page->Export == "" && !$Page->DrillDown && !$DashboardReport) { ?>
<script>
...
<div id="ew-center" class="<?php echo $event_registration_event_wise_rpt->CenterContentClass ?>">
<?php } ?>
...
<?php
	...
	$Page->renderRow();
?>
<form name="fevent_registration_event_wiserpt" id="fevent_registration_event_wiserpt" class="form-inline ew-form ew-ext-filter-form" action="<?php echo CurrentPageName() ?>">
<?php $searchPanelClass = ($Page->Filter <> "") ? " show" : " show"; ?>
<div id="fevent_registration_event_wiserpt-search-panel" class="ew-search-panel collapse<?php echo $searchPanelClass ?>">
...
?>
<span id="as_x_event_title" class="text-nowrap" style="z-index: 8970">
...
<input type="hidden" data-table="event_registration_event_wise" data-field="x_event_title" data-value-separator="<?php echo $Page->event_title->displayValueSeparatorAttribute() ?>" name="x_event_title" id="x_event_title" value="<?php echo HtmlEncode($Page->event_title->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script>
fevent_registration_event_wiserpt.createAutoSuggest({"id":"x_event_title","forceSelect":false});
</script>
</span>
</div>
</div>
...
<script>
fevent_registration_event_wiserpt.filterList = <?php echo $Page->getFilterList() ?>;
</script>
<!-- Search form (end) -->
<?php } ?>
...
<!-- Report grid (begin) -->
<?php if ($Page->Export <> "pdf") { ?>
<div id="gmp_event_registration_event_wise" class="<?php if (IsResponsiveLayout()) { echo "table-responsive "; } ?>ew-grid-middle-panel">
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="registration_id"><div class="event_registration_event_wise_registration_id"><span class="ew-table-header-caption"><?php echo $Page->registration_id->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="registration_id">
<?php if ($Page->sortUrl($Page->registration_id) == "") { ?>
		<div class="ew-table-header-btn event_registration_event_wise_registration_id">
			<span class="ew-table-header-caption"><?php echo $Page->registration_id->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_registration_event_wise_registration_id" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->registration_id) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->registration_id->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="registration_date"><div class="event_registration_event_wise_registration_date"><span class="ew-table-header-caption"><?php echo $Page->registration_date->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="registration_date">
<?php if ($Page->sortUrl($Page->registration_date) == "") { ?>
		<div class="ew-table-header-btn event_registration_event_wise_registration_date">
			<span class="ew-table-header-caption"><?php echo $Page->registration_date->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_registration_event_wise_registration_date" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->registration_date) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->registration_date->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="event_title"><div class="event_registration_event_wise_event_title"><span class="ew-table-header-caption"><?php echo $Page->event_title->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="event_title">
<?php if ($Page->sortUrl($Page->event_title) == "") { ?>
		<div class="ew-table-header-btn event_registration_event_wise_event_title">
			<span class="ew-table-header-caption"><?php echo $Page->event_title->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_registration_event_wise_event_title" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->event_title) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->event_title->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_name"><div class="event_registration_event_wise_user_name"><span class="ew-table-header-caption"><?php echo $Page->user_name->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_name">
<?php if ($Page->sortUrl($Page->user_name) == "") { ?>
		<div class="ew-table-header-btn event_registration_event_wise_user_name">
			<span class="ew-table-header-caption"><?php echo $Page->user_name->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_registration_event_wise_user_name" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->user_name) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->user_name->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="attendance_name"><div class="event_registration_event_wise_attendance_name"><span class="ew-table-header-caption"><?php echo $Page->attendance_name->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="attendance_name">
<?php if ($Page->sortUrl($Page->attendance_name) == "") { ?>
		<div class="ew-table-header-btn event_registration_event_wise_attendance_name">
			<span class="ew-table-header-caption"><?php echo $Page->attendance_name->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_registration_event_wise_attendance_name" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->attendance_name) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->attendance_name->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="event_date"><div class="event_registration_event_wise_event_date"><span class="ew-table-header-caption"><?php echo $Page->event_date->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="event_date">
<?php if ($Page->sortUrl($Page->event_date) == "") { ?>
		<div class="ew-table-header-btn event_registration_event_wise_event_date">
			<span class="ew-table-header-caption"><?php echo $Page->event_date->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_registration_event_wise_event_date" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->event_date) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->event_date->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="event_location"><div class="event_registration_event_wise_event_location"><span class="ew-table-header-caption"><?php echo $Page->event_location->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="event_location">
<?php if ($Page->sortUrl($Page->event_location) == "") { ?>
		<div class="ew-table-header-btn event_registration_event_wise_event_location">
			<span class="ew-table-header-caption"><?php echo $Page->event_location->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer event_registration_event_wise_event_location" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->event_location) ?>',2);">
			<span class="ew-table-header-caption"><?php echo $Page->event_location->caption() ?></span>
...
<?php include "event_registration_event_wise_pager.php" ?>
